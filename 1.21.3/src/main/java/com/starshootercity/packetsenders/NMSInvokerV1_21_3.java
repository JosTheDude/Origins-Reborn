...
public class NMSInvokerV1_21_3 extends NMSInvoker {
    ...
    public void sendPhasingGamemodeUpdate(Player player, GameMode gameMode) {
        ...
        ClientboundPlayerInfoUpdatePacket.Entry entry = new ClientboundPlayerInfoUpdatePacket.Entry(serverPlayer.getUUID(), serverPlayer.getGameProfile(), true, 1, gameType, serverPlayer.getTabListDisplayName(), 0, Optionull.map(serverPlayer.getChatSession(), RemoteChatSession::asData));
